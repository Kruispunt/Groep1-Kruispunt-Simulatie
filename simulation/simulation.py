...
class Simulation:
    def __init__(self, width, height):
        ...
        roadF.add_pedestrian_lane(Pedestrian_Lane(Vector2(1440, 211), [Vector2(1242, 410),], Vector2(1259, 223), connection=roadFp1, inbetween_light_positions=[Vector2(1341, 209),Vector2(1294, 185),Vector2(1262, 183),], chance_split=roadEp1_actual))
        ...
        roadF.add_cyclist_lane(Clyclist_Lane(Vector2(1215, 800), [Vector2(1250, 411), Vector2(1271, 195), Vector2(1342, 226),Vector2(1399, 226),], Vector2(1243, 521), inbetween_light_positions=[Vector2(1237, 563),], chance_split=roadBcl2))
        roadF.add_cyclist_lane(Clyclist_Lane(Vector2(1395, 227), [Vector2(1250, 411), Vector2(1215, 800) ], Vector2(1268, 220), inbetween_light_positions=[Vector2(1340, 227),Vector2(1263, 193),], chance_split=roadEc1))
        ...
        roadAp1_actual = Pedestrian_Lane(Vector2(1, 198), [Vector2(154, 357),], Vector2(163, 257), connection=roadAp1, inbetween_light_positions=[Vector2(153, 217),], chance_split=roadEp2_actual)
        roadAp2_actual = Pedestrian_Lane(Vector2(0, 575), [Vector2(150, 392), ], light_position=Vector2(131, 554),inbetween_light_positions=[Vector2(60, 576), Vector2(116, 611),Vector2(137, 610), ], chance_split=roadBp1_actual,connection=roadAp2)
        roadA.add_cyclist_lane(Clyclist_Lane(Vector2(0, 216), [Vector2(135, 374), Vector2(115, 586),], Vector2(150, 250), inbetween_light_positions=[Vector2(150, 219)], chance_split=roadEc2))
        roadA.add_cyclist_lane(Clyclist_Lane(Vector2(0, 556), [Vector2(135, 374), Vector2(172, 0),], Vector2(120, 550), inbetween_light_positions=[Vector2(60, 557),Vector2(116, 588),], chance_split=roadBcl1))
