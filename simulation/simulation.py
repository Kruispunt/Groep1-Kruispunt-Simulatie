...
class Simulation:
    def __init__(self, width, height):
        ...
        roadE = Road("E")
        roadEp1 = Pedestrian_Lane(Vector2(1117, 180), [Vector2(1280, 180),], Vector2(1126, 180), spawnable=False)
        roadEp2 = Pedestrian_Lane(Vector2(1117, 180), [Vector2(930, 180),], Vector2(1106, 180), spawnable=False)
        roadE.add_pedestrian_lane(Pedestrian_Lane(Vector2(1280, 180), [Vector2(1117, 180),], Vector2(1190, 180), connection=roadEp2))
        roadE.add_pedestrian_lane(roadEp1)
        roadE.add_pedestrian_lane(roadEp2)
        roadE.add_pedestrian_lane(Pedestrian_Lane(Vector2(930, 180), [Vector2(1117, 180),], Vector2(1005, 180), connection=roadEp1))
        ...
        roadFp2 = Pedestrian_Lane(Vector2(1242, 410), [Vector2(1262, 180),], Vector2(1245, 375), spawnable=False)
        ...
        roadF.add_pedestrian_lane(Pedestrian_Lane(Vector2(1262, 180), [Vector2(1242, 410),], Vector2(1259, 223), connection=roadFp1))
        ...
        roadA = Road("A")
        roadAp1 = Pedestrian_Lane(Vector2(154, 357), [Vector2(131, 608),], Vector2(149, 412), spawnable=False)
        ...
        roadA.add_pedestrian_lane(Pedestrian_Lane(Vector2(167, 239), [Vector2(154, 357),], Vector2(161, 275), connection=roadAp1))
        roadA.add_pedestrian_lane(roadAp2)
        roadA.add_pedestrian_lane(roadAp1)
        roadA.add_pedestrian_lane(Pedestrian_Lane(Vector2(132, 582), [Vector2(150, 392),], Vector2(131, 554), connection=roadAp2))
        ...
        roadB = Road("B")
        roadBp1 = Pedestrian_Lane(Vector2(269, 615), [Vector2(110, 615),], Vector2(266, 615), spawnable=False)
        roadBp2 = Pedestrian_Lane(Vector2(268, 615), [Vector2(460, 615),], Vector2(280, 615), spawnable=False)
        roadB.add_pedestrian_lane(Pedestrian_Lane(Vector2(117, 615), [Vector2(268, 615),], Vector2(196, 615), connection=roadBp2))
        roadB.add_pedestrian_lane(roadBp1)
        roadB.add_pedestrian_lane(roadBp2)
        roadB.add_pedestrian_lane(Pedestrian_Lane(Vector2(460, 615), [Vector2(268, 615),], Vector2(398, 615), connection=roadBp1))
